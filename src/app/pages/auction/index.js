                        ...
                        onClick={() => {
                          if (window.sessionStorage.getItem("userUUID")) {
                            ...
                            selectedGridsList.forEach((grid, idx) => {
                              ...
                              totalBidPrice += grid.bidPrice;
                              if (
                                grids[grid.gridIdx].info.maxBid >= grid.bidPrice
                              ) {
                            ...
                            getAuctionClose({
                              callback: (err, res) => {
                                if (err) {
                                  ...
                                  if (
                                    res.auction_close[0].auction_finish ===
                                    "yes"
                                  ) {
                                    window.alert(
        ...
        >
          <div
            style={{
              ...
              width: "13px",
              height: "13px",
              backgroundColor: displayMyLand ? "rgba(215,112,49,0.8)" : "white",
              borderRadius: "2px",
              marginLeft: "20px",
              marginRight: "-8px",
          ...
          ></div>
          <div data-tip data-for="myland">
            최고 입찰가
            <ReactTooltip
              id="myland"
              place="top"
              effect="solid"
              backgroundColor="rgba(225, 122, 24, 0.7)"
            >
              <span>최고 입찰가</span>
            </ReactTooltip>
          </div>
          ...
          <div
            style={{
              ...
              width: "13px",
              height: "13px",
              backgroundColor: "rgba(70,175,193,0.8)",
              borderRadius: "2px",
              marginLeft: "20px",
              marginRight: "-8px",
              border: "1px solid gray",
          ...
          ></div>
          <div data-tip data-for="posterior">
            후순위 입찰가
            <ReactTooltip
              id="posterior"
              place="top"
          ...
          ></div>
          <div data-tip data-for="selectedrange">
            리스트에서 선택된 땅
            <ReactTooltip
              id="selectedrange"
              place="top"
          ...
          <div
            style={{
              ...
              width: "13px",
              height: "13px",
              backgroundColor: "rgba(145,241,224,0.8)",
              borderRadius: "2px",
              marginLeft: "20px",
              marginRight: "-8px",
              border: "1px solid gray",
          ...
          ></div>
          <div data-tip data-for="abletopurchase">
            구매를 위해 선택한 땅
            <ReactTooltip
              id="abletopurchase"
              place="top"
