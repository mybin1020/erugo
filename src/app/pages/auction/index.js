    ...
    return (
        <>
            ...
            <div style={{ fontSize: '14px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '4px', color: window.selectedGrid.color, textShadow: '1px 0px 0px rgba(0, 0, 0)', fontWeight:'bold' }}>
                구매를 위해 선택한 땅 <div style={{ display: 'inline-block', width: size, height: size, backgroundColor: window.selectedGrid.color, border: '1px solid gray', borderRadius: '3px' }}></div>
            </div>
        {/* 추가 */}
            <div style={{ fontSize: '14px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '4px', color: 'rgba(0, 255, 0, 0.8)', textShadow: '1px 0px 0px rgba(0, 0, 0)', fontWeight:'bold' }}>
            최고 입찰가 중복 
            <div style={{ display: 'inline-block', width: size, height: size, backgroundColor: 'rgba(0, 255, 0, 0.8)', border: '1px solid gray', borderRadius: '3px' }}>
            </div>
            </div>
            ...
            <div style={{ fontSize: '14px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '4px', color :window.pickOnList.color, textShadow: '1px 0px 0px rgba(0, 0, 0)', fontWeight:'bold' }}>
                리스트에서 선택된 땅 <div style={{ display: 'inline-block', width: size, height: size, backgroundColor: window.pickOnList.color, border: '1px solid gray', borderRadius: '3px' }}></div>
            </div>
            ...
            <div style={{ fontSize: '14px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '4px', color: window.myNotHighestBid.color, textShadow: '1px 0px 0px rgba(0, 0, 0)', fontWeight:'bold' }}>
                후순위 입찰가 <div style={{ display: 'inline-block', width: size, height: size, backgroundColor: window.myNotHighestBid.color, border: '1px solid gray', borderRadius: '3px' }}></div>
            </div>
            <div style={{ fontSize: '14px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '4px', color: window.myHighestBid.color, textShadow: '1px 0px 0px rgba(0, 0, 0)', fontWeight:'bold' }}>
                최고 입찰가 <div style={{ display: 'inline-block', width: size, height: size, backgroundColor: window.myHighestBid.color, border: '1px solid gray', borderRadius: '3px', }}></div>
            </div>
        </>
    )
}
            ...
            <div style={{ width: 'calc(100% - 60px)', height: '100%', display: 'flex', flexDirection: 'row-reverse', alignItems: 'center', paddingRight: '40px', gap: '30px' }}>
                {
                    !showSPMap ? undefined :
                        selectedArea.exist ?
                                ...
                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                    {
                                        !showDetail ?
                                            <>
                                                <div style={{fontSize:'12px'}}>펴기</div>
                                                <BsFillCaretDownFill
                                                    className="pointer"
                                                    color={'white'}
                                            ...
                                            :
                                            <React.Fragment>
                                                 <div style={{fontSize:'12px'}}>접기</div>
                                                                ...
                                                                onClick={
                                                                    () => {
                                                                        ...
                                                                        setShowAlertConfirm({
                                                                            ...
                                                                            rugo:totalBidPrice,
                                                                            callback: (result) => {
                                                                                setShowAlertConfirm({ display: false, block:0, rugo:0, callback: () => { } })
                                                                                if (result === true) {
                            ...
                            :
                            <>
                                <div style={{fontSize:'12px'}}>선택된 영역이 없습니다.</div>
                                <ColorInfo />
                            </>
                }
            </div>
...
const AuctionPage = ({ menubar, footer, MapUrl, setLoadingMsg, setLoading, points, setPoints, userUUID, map }) => {
    ...
    userUUID_g = userUUID
    const [showAlertConfirm, setShowAlertConfirm] = useState({ display: false, rugo : 0, block:0, callback: () => { } })
    useEffect(() => {
    ...
    return (
        <React.Fragment>
            ...
            >
                <div
                    style={{
                        width: '700px', height: '500px', backgroundImage: 'url(/images/auction-confirm/background.png)', backgroundSize: 'contain', backgroundRepeat: 'no-repeat',
                        backgroundPosition: 'center', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '25px'
                    }}
                >
                    <div
                        style={{
                            width: '60%', height: '100%', backgroundImage: 'url(/images/auction-confirm/character.png)', backgroundSize: 'contain', backgroundRepeat: 'no-repeat',
                            backgroundPosition: 'center'
                        }}
                    >
                    ...
                    <div
                        style={{
                            width: '80%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '5px'
                        }}
                    >
                        <h6 style={{ color: 'white', fontSize: '20px', fontWeight: 'bold', marginBottom:'10px' }}>CONGRATULATIONS!</h6>
                        
                        <div style={{fontSize: '15px', color: 'white', fontWeight: 'bold', marginBottom:'10px'}}>고객님은 <span style={{color: 'orange'}}>[{showAlertConfirm.block}]</span>개 블록을 <span style={{color: 'orange'}}>[{showAlertConfirm.rugo}]</span> RUGO로 입찰하셨습니다.
                            </div>
                            <div style={{ fontSize: '14px', color: 'white', gap:'5px', marginRight: '10px' }}>
                            최종적으로 결정하시려면 본인 인증을 하시고 
                            최종 결정버튼을 눌러 주세요
                            <br/>
                            RECOME CODE <input type="text" value="" style={{border: 'none', width: '80px', margin: '20px'}}/>
                            <button style={{backgroundColor: "orange", color: "white", border: "none", borderRadius: "30px"}} onClick={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
                                //
                        ...
                        <div
                            className="pointer"
                            style={{
                                width: '300px', height: '40px', backgroundImage: 'url(/images/auction-confirm/button.png)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat',
                                backgroundPosition: 'center', marginTop:'30px'
                            }}
                            onClick={
                                (e) => {
                                    e.preventDefault()
