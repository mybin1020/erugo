...
import citizenship from './images/top-button/about2.png'
import messageButton from './images/top-button/message.png'
...
const TopMenu = ({ isLogin, onClick, languageCode, setLanguageCode }) => {
    ...
    return (
        <div className={Style['top-menu-background']} style={{ backgroundImage: 'url(/images/frame/top-menu.png)' }}>
            <div className={Style['logo']} style={{ backgroundImage: 'url(/images/frame/logo.png)' }}></div>
            <div className={Style['top-menu-button-wrapper']}>
                ...
                >
                    <img src={citizenship} alt="" style={{width: '100%', height: '99%'}}/>
                    </div>
                <div
                    style={{ backgroundImage: 'url(/images/frame/top-button/auction.png)' }}
                ...
                ></div>
                <div
                    style={{ backgroundImage: 'url(/images/frame/top-button/buy-land.png)' }}
                ...
                ></div>
                <div
                    style={{ backgroundImage: 'url(/images/frame/top-button/my-page.png)' }}
                ...
                ></div>
                <div
                    style={{ backgroundImage: 'url(/images/frame/top-button/market.png)' }}
                ...
                >
                    <img src={messageButton} alt="" style={{width: '100%', height: '99%'}}/>
                    </div>
                <div
                    style={{ backgroundImage: 'url(/images/frame/top-button/log-in.png)' }}
...
const Frame = ({ onCloseBunttonClick, onClick, frameName, frameIdx, frameOrder, detailFrameState, frameShowIdx, frameHideIdx, frameEle, children, first = true }) => {
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{ backgroundImage: `url(/images/detail-frame/${frameName}.png)` }}
            >
...
const MainGate = ({
    ...
    return (
        <div className={Style['page-background']} style={{ backgroundImage: 'url(/images/frame/lobby.jpeg)' }}>
            <div className={`${Style['plant']} ${Bounce['bounce-plant']}`} style={{ backgroundImage: 'url(/images/frame/plant.png)' }}>
            </div>
            <div className={`${Style['drone']} ${Bounce['bounce-drone']}`} style={{ backgroundImage: 'url(/images/frame/drone.png)' }}>
            </div>
            <div className={wrapperSlide === -10 ? Style['main-wrapper'] : Style['main-wrapper-dark']}>
                ...
                <div className={Style['main-contents']} >
                    <div
                        className={wrapperSlide === -10 ? Style['wrapper-10'] : Style['wrapper-0']}
                    >
                        <Frame
