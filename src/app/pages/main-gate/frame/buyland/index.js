...
const BuyLand = () => {
    ...
    return (
                    ...
                    <div className={Style["buyland-box"]}>
                        ...
                        <div className={Style['buyland-content-text']}>
                            <div>
                                ...
                                <p>
                                    이 위대한 제국의 일대기의 시작은 도시조차 제대로 이루지 못하고  일곱 언덕에서 자리를 잡고 전전긍긍하는 삶이었으며, 그 구성원들은     찬란한 미래보다 현실의 삶을 걱정하며 살아가는 처지였습니다.
                                </p>
                                <p>
                                    시간이 흐른 뒤, 그들은 한 가지 획기적인 생각을 하게 됩니다. 그리고 그 생각은 자신들의 삶을 윤택하게 만들어 주었으며 
                    ...
                    <div className={Style["buyland-box"]}>
                        ...
                        <div className={Style['buyland-content-text']}>
                            <div>
                                ...
                                <p>
                                    기존의 기득권자들과 시민들은 땅을 구매하여 새로운 시민이 된 자들을 차별 없는 동등한 위치로 받아들였습니다. 심지어 타지에서 들어와 투표를 통하여 왕이 될 수도 있었습니다.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={Style["buyland-box"]}>
                        ...
                        <div className={Style['buyland-content-text']}>
                            <div>
                                ...
                                <p>
                                    이 모든 것은 그들이 세계를 지배하는 대 제국으로 성장하는 밑거름이 되었지요.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <SwiperSlide className={Style['swiper-slide']}>
                    <div className={Style['buyland-box']}>
                        ...
                        <div className={Style['buyland-content-text']}>
                            <div>
                                <p>
                                    결과적으로 대 제국의 시대는 막을 내리게 되었지만, 그들의 문화와 역사는 지금까지도 지구 세계 여러 곳에서 영향을 끼치고 있습니다.
                                </p>
                                <p>
                    ...
                    <div className={Style["buyland-box"]}>
                        ...
                        <div className={Style['buyland-content-text']}>
                            <div>
                                ...
                                <p>
                                    개척자들은 고대 로마 제국과 같이 이루고 월드 타워에 대가를 치른 후 땅을 보유하게 되면 그 개척자는 시민권을 얻습니다.
                                </p>
                                <p>
                        ...
                        >
                            ...
                            <SwiperSlide className={Style['swiper-slide']}>
                                <div className={Style['buyland-swiper-text']}>
                                    ...
                                    <p>
                                        하지만, 하나의 땅에 한 장의 투표권이 생기는 만큼 자신이 땅을 얼마나 보유하느냐가 권력 행사의 관건이 될 것입니다. 또한, 보유한 땅에 따라 투표권을 제외한 별도의 권리가 추가됩니다.
                                    </p>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide className={Style['swiper-slide']}>
                                <div className={Style['buyland-swiper-text']}>
                                    ...
                                    <p className={Style['buyland-swiper-text-font']}>
                                        ※ 건의사항은 유저들의 투표 이후 법적 논의 후 문제가 없을 시 진행이 가능합니다.
                            ...
                            <SwiperSlide className={Style['swiper-slide']}>
                                <div className={Style['buyland-swiper-text']}>
                                    <div>
                                        ...
                                        <p>
                                        ※ 3계위 이상의 계급은 일정한 Rugo를 세금으로 거두게 됩니다. 이는 이루고 월드의 경제를 해치지 않는 선에서 책정이 되며, 자신의 권리를 증명하지 못하는 순간 세금 역시 거두지 못하게 됩니다. (최소 보유 땅 / EWC)
                                        </p>
                                        <p>
                                        모든 권력은 시민권과 투표에서부터 시작되기에 많은 땅과 투표권을 보유하고 있다면 권력이 커집니다. 다만, 일반 시민들이 권력의 균형을 이루고자 한다면, 전체 채팅과 온라인 채팅 센터를 통하여 이루고 월드 내에 활동중인 다른 개척자와 힘을 합쳐 자신들의 뜻을 관철시킬 수 있습니다.
                                        </p>
        ...
        modules={[Pagination]}
                            className={`${Style.mySwiper2} ${Style.swiperBuyland}`}
                        >
                            <SwiperSlide className={Style['swiper-slide']}>
                                <div className={Style['buyland-swiper-text']}>
                                    <div>
                            ...
                            <SwiperSlide className={Style['swiper-slide']}>
                                <div className={Style['buyland-swiper-text']}>
                                    <div>
                                        ...
                                        <p>
                                        상상하는 모든 것이 이루어지는 세계, 이루고 월드의 시민이 되어 당신의 권리를 보여주세요. 당신이 창조하는 세계를 우리에게 보여주세요. 이루고 월드가 기다리고 있습니다.
                                        </p>
