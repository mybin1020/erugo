        ...
        <SwiperSlide className={Style["swiper-slide"]}>
          <div className={Style["cityzenship-swiper-text"]}>
            ...
            <div className={Style["cityzenship-content-text"]}>
              ...
              <p>
              계급 유지를 위한 최소 보유 EWC는 존재하지 않으며
                보유 땅의 수량에 따라 투표권이 최소 1표부터 최대 9표까지
                지급됩니다. 
              </p>
              <p>
              이루고 월드에 입점된 사업체에서 물품 구입이
                가능합니다.
              </p>
            </div>
          </div>
        ...
        <SwiperSlide className={Style["swiper-slide"]}>
          <div className={Style["cityzenship-swiper-text"]}>
            ...
            <div className={Style["cityzenship-content-text"]}>
              ...
              <p>
              하우징 시스템을 이용하기 위해서는 최소 3*3의 토지를
                지니고 있어야 합니다.
              </p>
            </div>
          </div>
          ...
          <div className={Style["cityzenship-swiper-text"]}>
            ...
            <div className={Style["cityzenship-content-text"]}>
              ...
              <p>
                ...
                시작하여 대외적인 경제 활동이 가능합니다.
              </p>
              <p>
              3계위의 계급 유지를
                위한 최소 보유 EWC는 100 EWC입니다. 
              </p>
              <p>
              보유한 땅에 수량에 따라 최소
