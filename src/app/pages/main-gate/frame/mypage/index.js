...
const ExchangeEwcCoin = ({ether, coin, points}) => {
  ...
  <span className={Style['change-icon']}><img src={require('./images/icon3.png').default} alt="" width={'35px'}></img></span>
        ...
        <div className={Style['container']}>
          ...
          <div className={Style["pageBox2"]}>
              <div className={Style["exchange-xt"]}>
                ...
                type='text'
                          className={Style["input-box"]}
                          style={{ width: '100%', height: '100%', padding: '10px', borderRadius: '4px'}}
                          placeholder={'TX(transaction hash)값'}
                          onChange={
                              (e) => {
                                  if (onChange && typeof onChange === 'function') {
