  ...
  return (
    <>
      ...
      <input
        ...
        onChange={
          (e) => {
            let withdrawCoin = e.target.value === '' ? 0 : parseInt(e.target.value)
            ...
            <div className={Style["pageBox2"]}>
                            ...
                            callback: (err, res) => {
                              if (err) {
                                ...
                                if (res.result === 'success') {
                                    ...
                                    callback: (err, user) => {
                                      if (err) {
                                        ...
                                        if (user.result === 'success') {
                                          ...
                                          setPoints(point)
                                          setFees(fees)
                                          window.alert('EWC를 Security Wallet으로 부터 가져오는 데 성공하였습니다.')
                                        }
                                      }
                                    }
                                  })
                                  ...
                                  console.log(res)
                                  window.alert('EWC를 가져오는 데 실패하였습니다. Security Walle으로 부터의 Error Msg:' + res.data.err)
                                }
                              }
                            }
                          })
                        } else {
                          window.alert(`이루고 월드로 가져올 코인은 0보다 크고 ${Number(coin)}보다 작아야 합니다.`)
                        }
                      }
                    }
                  />
              ...
              <div className={Style["bg-down"]}>
                <div className={Style["box-bottom"]}>
                    ...
                    onClick={
                      (data) => {
                        if (data.rugo > 0 && data.ewc > 0) {
                          if (!window.confirm(`EWC ${data.ewc}개를 Rugo ${data.rugo}개로 전환하시겠습니까?`)) {
                            return
                          }
                          changePointEWC({
                            uuid: userUUID,
                  ...
                  />
                  <p className={Style['rugo-change-info']}>CURRENT EXCHANGE RATE : 1 Erugo Coin = {exchangeRate} Point </p>
                </div>
              </div>
              <button
